...
class Queen:
    def __init__(this):
        this.__total_health = King().ret_health() - 10 # total health of queen (less than king)
        this.__health = King().ret_health() - 10
    ...
    def ret_last_move(this):
        return this.__last_move
    
    def upd_last_move(this,x):
        this.__last_move = x
    ...
    def reset(this):
        this.upd_total_health(King().ret_health() - 10)
        this.upd_health(King().ret_health() - 10)
    ...
    def attack(this, screen, buildings):
        ...
        # sword sound every time queen attacks
